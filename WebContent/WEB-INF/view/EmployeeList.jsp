				...
				<tr>
					<td>${employee.employeeId }</td>
			 		...
			 		<td>${employee.grade == 0 ? "관리자" : "일반회원" }</td>
			  		<td><button type="button" class="updateBtn" value="${employee.employeeId}">수정</button></td>
					<td><button type="button" class="deleteBtn" value="${employee.employeeId}">삭제</button></td>
				</tr>
				</c:forEach>
